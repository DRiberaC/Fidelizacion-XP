    ...
    <div class="content">
        ...
        <div class="block block-rounded">
            ...
            <div class="block-content block-content-full">
                <form action="{{ route('cliente.update', [$cliente]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row push">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-8 col-xl-5">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="name" name="name"
                                    value="{{ $cliente->name }}" placeholder="Nombre">
                            </div>
                            <div class="mb-4">
                                <label class="form-label" for="last_name">Apellido</label>
                                <input type="text" class="form-control" id="last_name" name="last_name"
                                    value="{{ $cliente->last_name }}" placeholder="Apellido">
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="ci_nit" name="ci_nit"
                                    value="{{ $cliente->ci_nit }}" placeholder="CI/NIT">
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-xl-7">
                                    ...
                                    <input type="text" class="js-flatpickr form-control" id="subscription_start"
                                        name="subscription_start" value="{{ $cliente->subscription_start }}"
                                        placeholder="Y-m-d">
                                </div>
                            </div>
                        </div>
