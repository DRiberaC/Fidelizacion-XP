            ...
            <section class="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
                ...
                <div class="hidden lg:relative lg:block lg:p-12">
                    <a class="block text-white" href="/">
                        <span class="sr-only text-white">Home</span>
                    ...
                    <form class="mt-8 grid grid-cols-12 gap-12" action="{{ route('login') }}" method="POST">
                        ...
                        <div class="col-span-8 ">
                            ...
                            <input type="email"name="email"
                                class="mt-1 w-full py-2 px-3 block rounded-md border border-gray-300 outline-offset-2 outline-transparent focus:border-blue-600 focus:ring-2 focus:ring-blue-600 text-sm"
                                placeholder="email">
                        </div>
